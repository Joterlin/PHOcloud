...
async function main() {
    ...
    if (!loginHtml.includes("Straclase")) fail("/login no contiene la aplicación");
    ...
    console.log(
        `Straclase público correcto en ${baseUrl}; transferencias: ${readyData.transferStorage || "sin declarar"}.`
    );
}
